...
public class UserDao implements Dao {
   ...
   */
  public void updateRootFlagFromPermissions(DbSession dbSession, String login, String defaultOrganizationUuid) {
    long now = system2.now();
    UserMapper mapper = mapper(dbSession);
    mapper.updateRootUser(login, defaultOrganizationUuid, now);
    mapper.updateNonRootUser(login, defaultOrganizationUuid, now);
  }
