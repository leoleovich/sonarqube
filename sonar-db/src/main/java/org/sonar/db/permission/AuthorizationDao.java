...
public class AuthorizationDao implements Dao {
   ...
   * is deleted. The anyone virtual group is not taken into account.
   */
  public int countRemainingUsersWithGlobalPermissionIfExcludeUser(DbSession dbSession, String organizationUuid,
                                                                  String permission, long excludedUSerId) {
    return mapper(dbSession).countRemainingUsersWithGlobalPermissionIfExcludeUser(organizationUuid, permission, excludedUSerId);
  }
